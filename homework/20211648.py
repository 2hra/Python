...
#         if i == country:
#             return capital[i] ## result 위에 선언하고 예외처리 할 수 있도록 하기.
...
#     #### coding here ####
#     n_array = array[i-1:j]
#     n_array = sorted(n_array) ## np.sort()
#     answer = n_array[k-1]
#     return answer
...
for line in lines:
    ...
    num = file_name.replace('images/dog','')
    num = num.replace('.jpg','')
    ...
    if int(num) % 2 != 0:
        n_img = img.rotate(30, expand = True)
